...
RUNTIME_ERROR_SIGNALS = {
    ...
    signal.SIGABRT: "程序异常终止（可能是断言失败、内存分配失败、堆错误等）",  # 程序主动终止（可能是断言失败、内存分配失败、堆错误等）
    signal.SIGILL: "非法指令",     # 选手程序执行非法指令
    -signal.SIGSEGV: "段错误",
    -signal.SIGFPE: "浮点数错误", 
    -signal.SIGABRT: "程序异常终止（可能是断言失败、内存分配失败、堆错误等）",
    -signal.SIGILL: "非法指令",
    128 + signal.SIGSEGV: "段错误",
    128 + signal.SIGFPE: "浮点数错误",
    128 + signal.SIGABRT: "程序异常终止",
