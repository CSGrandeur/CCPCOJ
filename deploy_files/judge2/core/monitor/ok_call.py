...
C_CPP_RUN_WHITELIST = C_CPP_PLAYER_BASE | {"read", "write", "openat", "close", "fstat", "lseek", "getrusage"}
C_CPP_RUN_TPJ_WHITELIST = C_CPP_PLAYER_BASE | C_CPP_TPJ_RUN
