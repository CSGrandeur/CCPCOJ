...
-- 使用存储过程添加字段
-- 更新 cpc_team 表
CALL AddColumnIfNotExists('cpc_team', 'region', 'varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT "队伍所属国家"')$$
...
CALL AddColumnIfNotExists('loginlog', 'success', 'tinyint NOT NULL DEFAULT ''0'' AFTER `password`')$$
