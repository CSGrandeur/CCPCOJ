...
class Contest extends Csgojbase
{
    ...
    public function GetResultShow(&$solution)
    {
        ...
        $solution['res_show'] = $this->if_can_see_info($solution) && ($solution['result'] == 11 || (in_array($solution['result'], [5, 6, 7, 8, 9, 10, 90])  && ($this->IsContestAdmin('admin') || $this->ALLOW_WA_INFO)));
